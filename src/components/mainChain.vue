  ...
  <div class="mc_con">
    ...
    <div class="mc_search">
      <div class="mc_search1_2">
        ...
        <div class="mc_search2_1">
          ...
          <el-button type="primary" class="mc_search_submit" @click="to_search_height()">{{$t("placeholder.search")}}
          </el-button>
        </div>
      </div>
    </div>
    ...
    >
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh" @click="to_yifenpian(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="!is_zh" @click="to_yifenpian(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_bl_height(0,scope.row.chainId,scope.row.currentheight)">{{scope.row.currentheight}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    >
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_bl_height(1,scope.row.chainId,scope.row.currentheight)">{{scope.row.currentheight}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.current_committee_member')"
    ...
    >
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_bl_height_1(scope.row.chainId,scope.row.height)">{{scope.row.height}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    <el-button style="width: 100%;margin-bottom: 50px;margin-top: 20px" type="primary" @click="to_main_chainblock()">
    ...
    >
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="see_trfor_hash(scope.row.chainId,scope.row.txType,scope.row.hash)">{{slice_hash(scope.row.hash)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh" @click="see_tr_line(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="!is_zh" @click="see_tr_line(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.timestamp')"
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_address(0,scope.row.chainId,scope.row.from,scope.row.txType)">{{slice_hash(scope.row.from)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span :class="scope.row.txType==1?'to_tr':'to_tr show_color_choose'" @click="to_address(1,scope.row.chainId,scope.row.to,scope.row.txType)">{{slice_hash(scope.row.to)}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    <el-button style="width: 100%;margin-bottom: 50px;margin-top: 20px" type="primary" @click="to_main_tr()">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /*点击交易=>发起方---接收方=》信息地址查看*/
      to_address(peo, id, address, type) {
        if (peo == 0) {
