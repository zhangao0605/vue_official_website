<template>
  <div class="sbh_con">
    ...
    <!--<div class="con_title" style="font-size: 17px">-->
    <!--{{$t('table.ac_num')}}： <span style="color: #82848a;margin-left:20px">10 <span>THK</span></span>-->
    <!--</div>-->
    ...
    >
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_address(all_data.chainId,all_data.from)">{{slice_hash(scope.row.from)}}</span>
        </template>
      </el-table-column>
      <el-table-column
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      currentPageChange(e) {
        this.currentPage = e
        let data = {"chainId":this.all_data.chainId.toString(), "contract": this.all_data.contract, "page": this.currentPage, "pagesize": 10}
