  ...
  <div class="cta_con">
    ...
    <div class="cta_all">
      ...
      <div class="cta_all_con">
        ...
        <div class="cta_all_con_right show_color_choose" @click="to_address(all_data.chainId,all_data.from)">
          {{all_data.from}}
        </div>
      </div>
      <!--<div class="cta_all_con">-->
      ...
      <!--通过合约 <span class="show_color_choose" @click="to_contract()">0xb34fa4b69b981b3b892f805352d028a6499bda38</span>-->
      <!--转移 <span>{{all_data.value}}</span> THK从 <span class="show_color_choose"  @click="to_address(all_data.chainId,all_data.from)">{{all_data.from}}</span>-->
      <!--到  <span class="show_color_choose"  @click="to_address(all_data.chainId,all_data.to)">{{all_data.to}}</span>-->
      <!--</div>-->
      <!--</div>-->
      <div class="cta_all_con">
        <div class="cta_all_con_left">
        ...
        <div class="cta_all_con_right ">
          <span class="show_color_choose" @click="to_contract(all_data.chainId,all_data.to)">{{all_data.to}}</span>
