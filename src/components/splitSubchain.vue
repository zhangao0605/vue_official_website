  ...
  <div class="ss_con">
    ...
    <div class="ss_search">
      <div class="ss_search1_2">
        ...
        <div class="ss_search2_1">
          ...
          <el-button type="primary" class="ss_search_submit" @click="to_search_height()"> {{$t("placeholder.search")}}
          </el-button>
        </div>
      </div>
    </div>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh"
                @click="to_weifenpian(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="!is_zh"
                @click="to_weifenpian(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    >
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" @click="to_weifenpian(scope.row.chainId)" v-show="is_zh">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" @click="to_weifenpian(scope.row.chainId)" v-show="!is_zh">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.timestamp')"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose"
                @click="to_address(0,scope.row.chainId,scope.row.from,scope.row.txType)">{{slice_hash(scope.row.from)}}</span>
        </template>
      </el-table-column>
      <el-table-column
