    ...
    <div class="mcd_all">
      <div class="mcd_all_con">
        ...
        <div class="mcd_all_con_right" style="  user-select: none;">
          ...
          <span class="el-icon-caret-left mcd_icon" @click="change_block(0)"></span>
          <span class=" el-icon-caret-right mcd_icon" @click="change_block(1)"></span>
        </div>
      </div>
      <div class="mcd_all_con">
        <div class="mcd_all_con_left">
      ...
      <div class="mcd_all_con">
        ...
        <div class="mcd_all_con_right " style="cursor: pointer" @click="to_1(all_data.height)">
          <span class="color_choose">{{all_info_num}}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
          ( <span v-show="is_zh" v-for="item in tr_tial">{{item.txCount}} {{tr_change_zh(item.txType)}}，</span>
          <span v-show="!is_zh" v-for="item in tr_tial">{{item.txCount}} {{tr_change_en(item.txType)}}，</span> )
        </div>
      </div>
      <div class="mcd_all_con">
        <div class="mcd_all_con_left">
      ...
      <div class="mcd_all_con">
        ...
        <div class="mcd_all_con_right color_choose"  @click="change_block(0)">
      ...
      <div class="mcd_all_con">
        ...
        <div class="mcd_all_con_right " >
          <span class="color_choose" @click="see_commit()"> {{memberdetails.memlen}}</span>
        </div>
      </div>
      <div class="mcd_all_con">
        ...
        <div class="mcd_all_con_right mcd_all_con_right_last ">
          <span class="color_choose" v-for=" item in memberdetails.memberdetails" @click="cli_to_address(item)">
            {{item}}；&nbsp&nbsp&nbsp
          </span>
        </div>
      </div>
    ...
    methods: {
      ...
      getdata() {
        ...
        let data1 = {
          ...
          "epoch": Math.floor((Number(this.is_height) / 300)).toString()
        }
        ...
        getTxTypeByHeigh(data.chainId.toString(), data.height).then(response => {
          if (response.data.length == 0) {
            ...
            this.all_info_num = response.data.txtSumCount
            this.tr_tial = response.data.TxByTypeInfo
