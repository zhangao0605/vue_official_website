    ...
    <div class="ct_all">
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right show_color_choose">
          <!--<span class="to_tr color_choose" @click="to_block(all_data.height,all_data.chainId)"-->
                <!--v-show="is_zh">{{chainid_change_zh(all_data.chainId)+' > '+all_data.height==undefined?'':all_data.height}}</span>-->
          <!--<span class="to_tr color_choose" @click="to_block(all_data.height,all_data.chainId)"-->
                <!--v-show="!is_zh">{{chainid_change_en(all_data.chainId)+' > '+all_data.height==undefined?'':all_data.height}}</span>-->
          <span class="to_tr color_choose" @click="to_block(all_data.height,all_data.chainId)"
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right ">
          ...
          <!--{{timestampToTime(all_data.theDateString)}}-->
        </div>
      </div>
      <div class="ct_all_con">
        <div class="ct_all_con_left">
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right show_color_choose" @click="to_contract(all_data.chainId,all_data.to)">
          {{all_data.to}}
        </div>
      </div>
      <!--<div class="ct_all_con">-->
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right ct_all_con_right_last" style="height: 150px;user-select: none" v-show="is_ha">
          ...
          <span
            @click="to_de(Number(all_data_connectedTx.txType),all_data_connectedTx.chainId,all_data_connectedTx.hash)"
