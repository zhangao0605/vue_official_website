  ...
  <div class="hc_con">
    ...
    <div class="hc_overview hc_overview_1">
      <div>
        <span style="display: inline-block;line-height: 80px;font-size: 18px" class="color_choose"
              @click='to_main_chain()'>{{$t("title.main_chain")}}</span>
      </div>
      <div>
        <span class="hc_overview_he">{{$t("title.block_height")}}</span><br/>
        <br/>
        <span class="color_choose"
              @click="to_main_height(chain_data.currentheight)">{{chain_data.currentheight||0}}</span>
      </div>
    ...
    >
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr color_choose" v-show="is_zh" @click="to_yifenpian(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr color_choose" v-show="!is_zh" @click="to_yifenpian(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr color_choose" @click="to_bl_height(0,scope.row.chainId,scope.row.currentheight)">{{scope.row.currentheight}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    >
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr color_choose" v-show="is_zh" @click="to_weifenpian(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr color_choose" v-show="!is_zh" @click="to_weifenpian(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.block_height')"
        align="center">
        <template slot-scope="scope">
          <span class="to_tr color_choose" @click="to_bl_height(1,scope.row.chainId,scope.row.currentheight)">{{scope.row.currentheight}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.current_committee_member')"
    ...
    >
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr color_choose" @click="see_trfor_hash(scope.row.chainId,scope.row.txType,scope.row.hash)">{{slice_hash(scope.row.hash)}}</span>
        </template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr color_choose" @click="to_address(0,scope.row.chainId,scope.row.from,scope.row.txType)">{{slice_hash(scope.row.from)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template slot-scope="scope">
          <span :class="scope.row.txType==1?'to_tr':'to_tr color_choose'"
                @click="to_address(1,scope.row.chainId,scope.row.to,scope.row.txType)">{{slice_hash(scope.row.to)}}</span>
        </template>
      </el-table-column>
      <el-table-column
